...
### Code: Google_Search_Airport_Park_Transportation_Mall_By_City
...
## 4. Using Census API we are going to obtain more information of interest to choose a city when buying a property: Poverty rate, unemployment rate, gini index, walkable rate
...
## 5: School district rate, database found on internet.
### Code: School_Ranking_Analysis
